...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    EditText mPhoneNumberField, mVerificationField,nm,eml;
    Button mStartButton, mVerifyButton, mResendButton,lgn;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //nm = (EditText)findViewById(R.id.fullname);
        //eml = (EditText)findViewById(R.id.email);
        // lgn = (Button)findViewById(R.id.signin);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(new Intent(PhoneAuthActivity.this, HomePage.class));
                            finish();
                        } else {
